package abvtools.view;

import abvtools.utils.biometria.CapturarBiometria;
...
import abvtools.exception.ExceptionCustom;
import abvtools.exception.ExceptionMessage;
...
import abvtools.utils.Mensagens;
...
public class Biometria extends JDialog implements ActionListener {
    ...
    private void initComponents() {
        ...
        lbMensagem = new abvtools.componentes.rotulo.Rotulo();
        lbLink = new abvtools.componentes.rotulo.Rotulo();
        pnImagem = new javax.swing.JPanel();
        toolbarSair = new javax.swing.JToolBar();
        btnSair = new abvtools.componentes.botao.Botao();
    ...
    private abvtools.componentes.botao.Botao btnSair;
    private abvtools.componentes.rotulo.Rotulo lbLink;
    private abvtools.componentes.rotulo.Rotulo lbMensagem;
